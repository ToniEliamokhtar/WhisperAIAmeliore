...
Dans ce projet, je vais utiliser Open Web UI (vous m'en avez parlé lors de ma démo)
...
> le gitignore je l'ai fait après une petite recherche, mais on verra si ça va vraiment aider (les fichiers incluls)